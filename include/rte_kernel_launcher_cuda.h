...
namespace rte_kernel_launcher_cuda
{
    ...
    void sw_solver_2stream(const int ncol, const int nlay, const int ngpt, const BOOL_TYPE top_at_1,
                           ...
                           Array_gpu<TF,2>& flux_up, Array_gpu<TF,2>& flux_dn, Array_gpu<TF,2>& flux_dir, Tuner_map& tunings);
    ...
    void lw_solver_noscat_gaussquad(
            ...
            const Array_gpu<TF,1>& sfc_src_jac, Array_gpu<TF,2>& flux_up_jac, Tuner_map& tunings);
}
#endif
