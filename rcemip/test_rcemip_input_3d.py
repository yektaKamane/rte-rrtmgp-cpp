...
nc_file.createDimension("col_x", n_col_x)
nc_file.createDimension("col_y", n_col_y)
...
nc_p_lay = nc_file.createVariable("p_lay", float_type, ("lay", "col_y", "col_x",))
nc_p_lev = nc_file.createVariable("p_lev", float_type, ("lev", "col_y", "col_x",))
nc_p_lay[:,:,:] = np.tile(p_lay[:,None, None], (1, n_col_y, n_col_x))
nc_p_lev[:,:,:] = np.tile(p_lev[:,None, None], (1, n_col_y, n_col_x))

nc_T_lay = nc_file.createVariable("t_lay", float_type, ("lay", "col_y", "col_x",))
nc_T_lev = nc_file.createVariable("t_lev", float_type, ("lev", "col_y", "col_x",))
...
nc_O3  = nc_file.createVariable("vmr_o3" , float_type, ("lay", "col_y", "col_x",))
nc_H2O = nc_file.createVariable("vmr_h2o", float_type, ("lay", "col_y", "col_x",))
...
nc_emis_sfc = nc_file.createVariable("emis_sfc" , float_type, ("col_y", "col_x", "band_lw"))
nc_t_sfc = nc_file.createVariable("t_sfc" , float_type, ("col_y", "col_x",))
...
nc_mu0 = nc_file.createVariable("mu0", float_type, ("col_y", "col_x",))
nc_sfc_alb_dir = nc_file.createVariable("sfc_alb_dir", float_type, ("col_y", "col_x", "band_sw"))
nc_sfc_alb_dif = nc_file.createVariable("sfc_alb_dif", float_type, ("col_y", "col_x", "band_sw"))
nc_tsi = nc_file.createVariable("tsi", float_type, ("col_y", "col_x",))
